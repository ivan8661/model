...
public interface UserActionService {
     ...
     * @param user       The user's DTO associated with the action.
     * @param userAction The user action's DTO to be saved.
     ...
     * @param userDTO The user for whom actions are retrieved.
     * @return A list of user actions associated with the user.
     */
    List<UserActionDTO> getUserActions(UserDTO userDTO) throws SQLException;
     ...
     */
    List<UserActionDTO> getAllUsersActions() throws SQLException;
}
